...
import {
    ...
    LabelPairedSparklesCaptionBoldIcon,
...
const WorkspaceGroup = observer(() => {
    ...
    const { setPreviewOnPopup, setChartModalVisibility, setProAnalysisModalVisibility } = dashboard;
            ...
            <div className='toolbar__group toolbar__group-btn' data-testid='dt_toolbar_group_btn'>
                ...
                {isDesktop && (
                    <>
                        ...
                        />
                        <ToolbarIcon
                            popover_message={localize('Pro Analysis Tool')}
                            icon={
                                <span
                                    className='toolbar__icon'
                                    id='db-toolbar__pro-analysis-button'
                                    onClick={() => setProAnalysisModalVisibility()}
                                >
                                    <LabelPairedSparklesCaptionBoldIcon height='24px' width='24px' />
                                </span>
                            }
                        />
                    </>
                ...
                <div className='vertical-divider' />
                <ToolbarIcon
                    popover_message={localize('Signals Scanner')}
                    icon={
                        <span
                            className='toolbar__icon'
                            id='db-toolbar__scanner-button'
                            onClick={() => dashboard.setFloatingScannerVisibility(true)}
                        >
                            <LabelPairedSearchCaptionRegularIcon height='24px' width='24px' />
                        </span>
                    }
                />
                <div className='vertical-divider' />
